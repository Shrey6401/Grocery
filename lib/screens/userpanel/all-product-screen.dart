      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          return GridView.builder(
            ...
            // Since this is a separate page, we remove shrinkWrap
            // and let it scroll naturally.
            shrinkWrap: false,
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 10,
              crossAxisSpacing: 10,
              // 0.7 or 0.75 is the "sweet spot" to avoid bottom overflow
              // when using images + two lines of text.
            ...
            itemBuilder: (context, index) {
              ...
              return FillImageCard(
                borderRadius: 15,
                width: Get.width / 2.3,
                heightImage: 140, // Consistent height for all images
